...
x.t("example.pl.gs.wsic.myservice.ports.report_p1","note");
...
x.t("java.io.file","web");
x.t("finished","asynchronous");
x.t("example.pl.gs.wsic.myservice.sayhello","call");
x.t("whose","schema");
x.t("upon","first");
...
x.t("/wsi/remote/greatwebservice","load");
x.t("wsdl2gosu.fetch","new");
x.t("signed","messages");
x.t("send","request");
x.t("ws.myservice.sayhello","create");
x.t("free","web");
x.t("san","francisco");
...
x.t("example.pl.gs.wsic.myservice.ports.report_hellop2","duplicate");
