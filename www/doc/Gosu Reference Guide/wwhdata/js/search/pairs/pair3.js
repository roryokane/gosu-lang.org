...
x.t("required","class");
x.t("myrecord.mychildlist.length","//some");
...
x.t("abc","class");
x.t("gw.example.queues.jms","wildcard");
...
x.t("expose","actual");
x.t("expose","data");
x.t("myclass.propertyname","static");
x.t("down","object");
x.t("compiles","runs");
...
x.t("com.guidewire.pl.docexamples.gosu.xml.demochildprops.element1","create");
x.t("especially","easy");
...
x.t("xs:id","use=");
x.t("service.config.http.authentication.basic.password","call");
x.t("pass","statement");
x.t("pass","multiple");
...
x.t("example.gosu.wsi.myservice.sayhello","security");
...
x.t("(decrement-by-one)","(subtract-and-assign)");
